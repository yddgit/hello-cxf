...
public class CalcService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/F:/tools/sts-bundle/sts-3.8.3.RELEASE/workspace/hello-cxf/src/main/resources/META-INF/wsdl/calc.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CalcService_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/F:/tools/sts-bundle/sts-3.8.3.RELEASE/workspace/hello-cxf/src/main/resources/META-INF/wsdl/calc.wsdl");
        }
        WSDL_LOCATION = url;
    }
